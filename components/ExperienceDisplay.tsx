...
function ExpDisplay({ exp }: {
    ...
    return (
        <div className="flex flex-col bg-white overflow-hidden rounded-xl justify-start max-w-md sm:mx-5 my-10 flex-grow-0 flex-shrink-0 hover:scale-105 transition-transform">
